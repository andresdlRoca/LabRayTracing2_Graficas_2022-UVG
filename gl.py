...
class Raytracer(object):
    ...
    def cast_ray(self, orig, dir, sceneObj = None, recursion = 0):
        ...
        if material.matType == OPAQUE:
            ...
            refract = reflectVector(intersect.normal, dir * -1)
            refractOrig = ml.add(intersect.point, bias) if outside else ml.subtract(intersect.point, bias)
            reflectColor = self.cast_ray(refractOrig, refract, None, recursion + 1)
            reflectColor = reflectColor
